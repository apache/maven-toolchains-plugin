...
Custom Toolchains
  ...
  {{{../scm.html}the plugin source tree}}:
...
* Creating a Custom Toolchain
  ...
  * a {{{/ref/current/maven-core/apidocs/org/apache/maven/toolchain/ToolchainFactory.html}<<<org.apache.maven.toolchain.ToolchainFactory>>>}},
  provided as {{{https://maven.apache.org/maven-jsr330.html}JSR-330 component}} annotated with <<<@Named("<toolchainType>")>>>
  (e.g. <<<@Named("custom")>>>) and <<<@Singleton>>>.
